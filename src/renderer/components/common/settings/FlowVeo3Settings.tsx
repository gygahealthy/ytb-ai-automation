...
import { RefreshCw, Check, AlertCircle, Filter, Copy } from "lucide-react";
...
export default function FlowVeo3Settings() {
  ...
  const { models, lastSyncedAt, isSyncing, setModels, setSyncing, setDefaultForRender, toggleUsage, getFilteredModels } =
    useVEO3ModelsStore();
