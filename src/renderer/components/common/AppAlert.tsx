...
const severityMap: Record<Severity, { bg: string; iconBg: string; text: string; Icon: any }> = {
  ...
  warning: {
    ...
    iconBg: "bg-amber-100 dark:bg-amber-700",
...
export default function AppAlert({ title = "Notice", message, onClose, severity = "info", onConfirm }: AppAlertProps) {
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between">
              ...
              <div>
                <button onClick={onClose} className={`text-sm font-medium ml-4 text-gray-600 dark:text-gray-300`}>
                  Close
                </button>
              </div>
            </div>
