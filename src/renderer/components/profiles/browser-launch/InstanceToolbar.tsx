        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="flex items-center gap-2 relative">
            ...
            <button
              ...
              onClick={async () => {
                setOverridePreset("1x2-vertical");
                await applyPresetAndRefresh("1x2-vertical");
              }}
              className={`w-8 h-8 rounded border flex items-center justify-center transition-all ${
                displayedPreset === "1x2-vertical"
                  ? "border-primary-500 bg-primary-50 dark:bg-primary-900/20"
                  : "border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
              }`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="3" width="18" height="8" stroke="currentColor" strokeWidth="1.5" />
                <rect x="3" y="13" width="18" height="8" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
              </svg>
            </button>
            <button
              title="2 x 1 — 2 columns × 1 row (horizontal)"
              onClick={async () => {
                setOverridePreset("1x2-horizontal");
                await applyPresetAndRefresh("1x2-horizontal");
              }}
              className={`w-8 h-8 rounded border flex items-center justify-center transition-all ${
                displayedPreset === "1x2-horizontal"
                  ? "border-primary-500 bg-primary-50 dark:bg-primary-900/20"
                  : "border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
              }`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="3" width="8" height="18" stroke="currentColor" strokeWidth="1.5" />
                <rect x="13" y="3" width="8" height="18" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
              </svg>
            </button>
            <button
              title="2x2"
              onClick={async () => {
                setOverridePreset("2x2");
                await applyPresetAndRefresh("2x2");
              }}
              className={`w-8 h-8 rounded border flex items-center justify-center transition-all ${
                displayedPreset === "2x2"
                  ? "border-primary-500 bg-primary-50 dark:bg-primary-900/20"
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="3" y="13" width="8" height="8" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
                <rect x="13" y="13" width="8" height="8" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
              </svg>
            </button>
            <button
              title="4x4"
              onClick={async () => {
                setOverridePreset("4x4");
                await applyPresetAndRefresh("4x4");
              }}
              className={`w-8 h-8 rounded border flex items-center justify-center transition-all ${
                displayedPreset === "4x4"
                  ? "border-primary-500 bg-primary-50 dark:bg-primary-900/20"
            ...
            <button
              title="Cascade"
              onClick={async () => {
                setOverridePreset("cascade");
                await applyPresetAndRefresh("cascade");
              }}
              className={`w-8 h-8 rounded border flex items-center justify-center transition-all ${
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="3" width="14" height="10" stroke="currentColor" strokeWidth="1.5" />
                <rect x="7" y="7" width="14" height="10" stroke="currentColor" strokeWidth="1.2" opacity="0.6" />
              </svg>
            </button>
          </div>
