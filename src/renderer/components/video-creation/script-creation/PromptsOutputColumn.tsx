                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-bold text-purple-600 dark:text-purple-400">Scene {prompt.sceneNumber}</span>
                        <span className="text-xs text-gray-500 dark:text-gray-400">• {prompt.duration}s</span>
                      </div>
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 border-t border-gray-200 dark:border-gray-700 pt-4 bg-white dark:bg-gray-800">
                    <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 mb-3">
                      ...
                      <div className="text-sm text-gray-900 dark:text-white whitespace-pre-wrap">{prompt.prompt}</div>
                    </div>
