...
import StrategyModal from '../../components/channel-management/StrategyModal';
import PromptModal from '../../components/admin/PromptModal';
import UpcomingTopics from '../../components/channel-management/UpcomingTopics';
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/video-creation/channels')} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
            Back to Channels
          </button>
        </div>
      </div>
    ...
    <div className="h-screen overflow-hidden bg-white dark:bg-gray-950 flex flex-col">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {performance && performance.growth.subscribers !== 0 && (
                        <div className={`flex items-center gap-0.5 text-[10px] ${
                          ...
                          {performance.growth.subscribers > 0 ? <TrendingUp className="w-3 h-3" /> : <TrendingDown className="w-3 h-3" />}
                          <span className="font-semibold">{performance.growth.subscribers > 0 ? '+' : ''}{formatNumber(performance.growth.subscribers)}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {performance && performance.growth.views !== 0 && (
                        <div className={`flex items-center gap-0.5 text-[10px] ${
                          ...
                          {performance.growth.views > 0 ? <TrendingUp className="w-3 h-3" /> : <TrendingDown className="w-3 h-3" />}
                          <span className="font-semibold">{performance.growth.views > 0 ? '+' : ''}{formatNumber(performance.growth.views)}</span>
                        </div>
                      )}
                    </div>
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Strategy</div>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Competitors</div>
                    <div className="text-xs font-semibold text-gray-700 dark:text-gray-300">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="max-w-[1800px] mx-auto px-6 py-6 h-full">
          <div className="grid grid-cols-3 gap-6 h-full">{/* Takes full available height */}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-3 text-xs">
                            ...
                            <div className="flex items-center gap-1">
                              <span>💬</span>
                              <span className="font-medium text-gray-600 dark:text-gray-400">{formatNumber(video.comments)}</span>
                            </div>
                          </div>
                        </div>
                      </div>
