    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-slate-900 dark:text-white">
      <div className="w-full px-6 py-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold">
                Video Platform Analysis Prompts
              </h1>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                Configure master prompts for content analysis
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div>
            <button onClick={() => { setEditing({ provider: selectedProvider, promptKind: 'video_analysis', description: '', promptTemplate: '' }); setModalOpen(true); }} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all font-medium">
