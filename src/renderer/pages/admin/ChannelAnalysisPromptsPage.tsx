...
const ChannelAnalysisPromptsPage: React.FC = () => {
  ...
  const openAddModal = () => { setEditing({ provider: 'youtube', promptKind: 'channel_analysis', description: '', promptTemplate: '' }); setModalOpen(true); };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="w-full px-6 py-6 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">
                YouTube Channel Analysis Prompts
              </h1>
              <p className="text-slate-600 dark:text-slate-400 mt-1">
                Configure master prompts for channel evaluation
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-end mb-4">
          <button onClick={openAddModal} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white text-sm font-medium rounded-lg hover:shadow-md transition-all">
