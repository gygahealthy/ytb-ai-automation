...
function computeDigest(template: string | undefined | null, description: string | undefined | null, tags: string[] | undefined | null) {
...
// Use the underlying SQLiteDatabase instance so the repository has .run/.get/.all methods
export const promptHistoryRepository = new PromptHistoryRepository(database.getSQLiteDatabase());
